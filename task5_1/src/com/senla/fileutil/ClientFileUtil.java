...
public final class ClientFileUtil implements IClientFileUtil<Client> {
	...
	public Client[] readFromFile() throws NumberFormatException, ParseException, IOException {
	...
	public Client fromLine(final String line) throws NumberFormatException, ParseException, IOException {
