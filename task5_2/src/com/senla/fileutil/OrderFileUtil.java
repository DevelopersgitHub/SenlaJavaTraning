...
public final class OrderFileUtil implements IOrderFileUtil<Order> {
	...
	public Order[] readFromFile() throws NumberFormatException, ParseException, IOException {
	...
	public Order fromLine(final String line) throws NumberFormatException, ParseException, IOException {
